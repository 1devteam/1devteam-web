...
const checks = [
  ['Muted text on page background', colors.textMuted, colors.bg, 4.5],
  ['Muted text on surface', colors.textMuted, colors.surface, 4.5],
  ['Muted text on white', colors.textMuted, colors.white, 4.5],
  ['Brand text on page background', colors.brandText, colors.bg, 4.5],
  ['Brand text on surface', colors.brandText, colors.surface, 4.5],
  ['Brand text on white', colors.brandText, colors.white, 4.5],
  ['Filled action text', colors.brandInk, colors.brandAction, 4.5],
  ['Footer primary secondary text', colors.slate300, colors.navy, 4.5],
  ['Footer fine print', colors.slate400, colors.navy, 4.5],
