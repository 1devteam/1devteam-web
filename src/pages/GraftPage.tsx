  ...
  return (
    <>
      ...
      <PageHero
        ...
        description="Graph Reasoning for Architecture, Fidelity & Traceability. This is the working G.R.A.F.T.+ prototype and its user guide: two reconstruction subjects, visible residuals, and a fact packet a planner can consume. It is not a planner and not merge authority."
      >
